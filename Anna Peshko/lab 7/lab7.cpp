...
/*Квадратный метр. Программа для риэлтерской компании. База
предложения недвижимости: район и адрес, этаж, площадь, тип
планировки, цена. База спроса: требования покупателя к жилью
(возможно несколько вариантов, допустимые диапазоны, например:
“однокомнатная до 40.000, Малиновку и Шабаны не предлагать”),
финансовые возможности, контакты. Регистрация собственников и
покупателей, поиск по всем полям, подбор вариантов для той и
другой стороны, автоматизированный поиск взаимоприемлемых
вариантов. Удаление при состоявшейся сделке или отказе от услуг.
